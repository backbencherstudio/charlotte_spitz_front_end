...
export default function LogoutModal() {
  ...
  return (
    <div>
      <Dialog>
        <DialogTrigger className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-red-600 hover:bg-red-50 transition-colors duration-200 cursor-pointer">
